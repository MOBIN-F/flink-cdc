...
public class CustomMySqlAntlrDdlParser extends MySqlAntlrDdlParser {
    ...
    public CustomMySqlAntlrDdlParser(boolean includeComments, boolean isCastTinyIntToInt) {
    ...
    protected AntlrDdlParserListener createParseTreeWalkerListener() {
        return new CustomMySqlAntlrDdlParserListener(this, parsedEvents, isCastTinyIntToInt);
    }
