...
import static org.apache.flink.cdc.connectors.values.sink.ValuesDataSinkOptions.SINK_SCHEMA_INFO_ENABLE;
    ...
    public void testConvertEventToStr() {
        ...
        Assert.assertEquals(
                ...
                ValuesDataSinkHelper.convertEventToStr(
                        ...
                        fieldGetters,
                        SINK_SCHEMA_INFO_ENABLE.defaultValue()));
        ...
        Assert.assertEquals(
                ...
                ValuesDataSinkHelper.convertEventToStr(
                        insertEvent, fieldGetters, SINK_SCHEMA_INFO_ENABLE.defaultValue()));
        ...
        Assert.assertEquals(
                ...
                ValuesDataSinkHelper.convertEventToStr(
                        deleteEvent, fieldGetters, SINK_SCHEMA_INFO_ENABLE.defaultValue()));
        ...
        Assert.assertEquals(
                ...
                ValuesDataSinkHelper.convertEventToStr(
                        updateEvent, fieldGetters, SINK_SCHEMA_INFO_ENABLE.defaultValue()));
    }
}
