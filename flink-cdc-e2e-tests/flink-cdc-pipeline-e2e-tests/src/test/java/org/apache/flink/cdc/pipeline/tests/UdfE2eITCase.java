...
//                                + "    projection: ID, VERSION, addone(addone(ID)) AS INC_ID,
// format('<%%s>', VERSION) AS FMT_VER\n"
//                                + "    filter: addone(ID) <> '1009'\n"
//                                + "  - source-table: %s.TABLEBETA\n"
//                                + "    projection: ID, VERSION, answer() AS ANS, typeof(ID) AS
// TYP\n"
//                                + "\n"
//                                + "pipeline:\n"
//                                + "  parallelism: %d\n"
...
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEALPHA, before=[], after=[1011, 11, 1013,
// <11>], op=INSERT, meta=()}",
//                        transformRenameDatabase.getDatabaseName()),
//                60000L);
//
//        waitUntilSpecificEvent(
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2014, 14,
// Forty-two, Integer: 2014], op=INSERT, meta=()}",
//                        transformRenameDatabase.getDatabaseName()),
//                60000L);
//
...
//                Arrays.asList(
//                        String.format(
//                                "CreateTableEvent{tableId=%s.TABLEALPHA, schema=columns={`ID` INT
// NOT NULL,`VERSION` VARCHAR(17),`INC_ID` STRING,`FMT_VER` STRING}, primaryKeys=ID, options=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEALPHA, before=[], after=[1009,
// 8.1, 1011, <8.1>], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEALPHA, before=[], after=[1010,
// 10, 1012, <10>], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEALPHA, before=[], after=[1011,
// 11, 1013, <11>], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "CreateTableEvent{tableId=%s.TABLEBETA, schema=columns={`ID` INT
// NOT NULL,`VERSION` VARCHAR(17),`ANS` STRING,`TYP` STRING}, primaryKeys=ID, options=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2011, 11,
// Forty-two, Integer: 2011], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2012, 12,
// Forty-two, Integer: 2012], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2013, 13,
// Forty-two, Integer: 2013], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2014, 14,
// Forty-two, Integer: 2014], op=INSERT, meta=()}",
...
//        waitUntilSpecificEvent(
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEALPHA, before=[1009, 8.1, 1011, <8.1>],
// after=[1009, 100, 1011, <100>], op=UPDATE, meta=()}",
//                        transformRenameDatabase.getDatabaseName()),
//                20000L);
//
//        waitUntilSpecificEvent(
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEALPHA, before=[], after=[3007, 7, 3009,
// <7>], op=INSERT, meta=()}",
//                        transformRenameDatabase.getDatabaseName()),
//                20000L);
//
//        waitUntilSpecificEvent(
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEBETA, before=[2011, 11, Forty-two,
// Integer: 2011], after=[], op=DELETE, meta=()}",
//                        transformRenameDatabase.getDatabaseName()),
//                20000L);
//    }
//
...
//                        String.format(
//                                "CreateTableEvent{tableId=%s.TABLEBETA, schema=columns={`ID` INT
// NOT NULL,`VERSION` VARCHAR(17),`TYP` STRING}, primaryKeys=ID, options=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2011, 11,
// Integer: 2011], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2012, 12,
// Integer: 2012], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2013, 13,
// Integer: 2013], op=INSERT, meta=()}",
//                                transformRenameDatabase.getDatabaseName()),
//                        String.format(
//                                "DataChangeEvent{tableId=%s.TABLEBETA, before=[], after=[2014, 14,
// Integer: 2014], op=INSERT, meta=()}",
...
//        waitUntilSpecificEvent(
//                String.format(
//                        "DataChangeEvent{tableId=%s.TABLEBETA, before=[2011, 11, Integer: 2011],
