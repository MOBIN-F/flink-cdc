...
//                                        "103,12-pack drill bits,12-pack of drill bits with sizes
// ranging from #40 to #3,0.8,red,{\"key3\":
...
//                            "jdbc:mysql://%s:%s/%s",
//                            MYSQL.getHost(), MYSQL.getDatabasePort(), uniqueDatabaseName);
//            return DriverManager.getConnection(mysqlJdbcUrl, MYSQL_TEST_USER,
// MYSQL_TEST_PASSWORD);
//        }
