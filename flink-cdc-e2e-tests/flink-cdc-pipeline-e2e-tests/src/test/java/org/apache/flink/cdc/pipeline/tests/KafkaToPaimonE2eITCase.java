...
/**
 * End-to-end tests for a multi-partition Kafka Debezium JSON to Paimon pipeline, covering create
 * table, add column, alter column type, DML, cross-partition historical replay, rename-as-superset
 * and multi-table sync.
 */
class KafkaToPaimonE2eITCase extends PipelineTestEnvironment {
    ...
    @Test
    void testCreateTableAddColumnModifyColumnAndDml() throws Exception {
        submitKafkaToPaimonJob();
    ...
    @Test
    void testMultiTableFromSameTopic() throws Exception {
    ...
    private void submitKafkaToPaimonJob() throws Exception {
    ...
    private String buildPipelineJob() {
        return String.format(
                ...
                topic, UUID.randomUUID(), KAFKA_ALIAS, DATABASE, warehouse);
    }
    ...
    private static String orderFields() {
