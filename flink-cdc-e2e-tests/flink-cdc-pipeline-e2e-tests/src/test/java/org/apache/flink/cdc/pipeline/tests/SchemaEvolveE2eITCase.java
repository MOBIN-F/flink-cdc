...
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1012, Eve, 17, 0],
// op=INSERT, meta=()}",
...
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1013, Fiona, 16.0],
// op=INSERT, meta=()}",
//                        "TruncateTableEvent{tableId=%s.members}",
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1014, Gem, 17.0],
// op=INSERT, meta=()}",
...
// addedColumns=[ColumnWithPosition{column=`gender` TINYINT, position=AFTER,
// existedColumnName=age}]}",
//                        "DataChangeEvent{tableId=%s.merged, before=[], after=[1012, Eve, 17, 0],
// op=INSERT, meta=()}",
//                        "AlterColumnTypeEvent{tableId=%s.merged, typeMapping={age=DOUBLE},
// oldTypeMapping={age=INT}}",
//                        "AddColumnEvent{tableId=%s.merged,
// addedColumns=[ColumnWithPosition{column=`precise_age` DOUBLE, position=AFTER,
// existedColumnName=gender}]}",
//                        "AddColumnEvent{tableId=%s.merged,
// addedColumns=[ColumnWithPosition{column=`biological_sex` TINYINT, position=AFTER,
// existedColumnName=precise_age}]}",
//                        "DataChangeEvent{tableId=%s.merged, before=[], after=[1013, Fiona, null,
// null, 16.0, null], op=INSERT, meta=()}",
//                        "DataChangeEvent{tableId=%s.merged, before=[], after=[1014, Gem, null,
// null, 17.0, null], op=INSERT, meta=()}"));
//    }
//
//    @Test
//    @Disabled
...
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1012, Eve, 17],
// op=INSERT, meta=()}",
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1013, Fiona, null],
// op=INSERT, meta=()}",
//                        "DataChangeEvent{tableId=%s.members, before=[], after=[1014, Gem, null],
// op=INSERT, meta=()}"),
//                Arrays.asList(
...
// nameMapping={age=precise_age}}, but keeps running in tolerant mode. Caused by:
// UnsupportedSchemaChangeEventException{applyingEvent=RenameColumnEvent{tableId=%s.members,
// nameMapping={age=precise_age}}, exceptionMessage='Rejected schema change event since
// error.on.schema.change is enabled.', cause='null'}",
//                        "Failed to apply schema change RenameColumnEvent{tableId=%s.members,
...
// addedColumns=[ColumnWithPosition{column=`gender` TINYINT, position=LAST,
// existedColumnName=null}]}",
//                        "DataChangeEvent{tableId=%s.redirect, before=[], after=[1012, Eve, 17, 0],
// op=INSERT, meta=()}",
//                        "AlterColumnTypeEvent{tableId=%s.redirect, typeMapping={age=DOUBLE},
// oldTypeMapping={age=INT}}",
//                        "AddColumnEvent{tableId=%s.redirect,
// addedColumns=[ColumnWithPosition{column=`precise_age` DOUBLE, position=LAST,
// existedColumnName=null}]}",
...
// addedColumns=[ColumnWithPosition{column=`biological_sex` TINYINT, position=LAST,
// existedColumnName=null}]}",
//                        "DataChangeEvent{tableId=%s.redirect, before=[], after=[1013, Fiona, null,
// null, 16.0, null], op=INSERT, meta=()}",
//                        "DataChangeEvent{tableId=%s.redirect, before=[], after=[1014, Gem, null,
// null, 17.0, null], op=INSERT, meta=()}");
//
...
//                Stream.of(
//                                "CreateTableEvent{tableId=%s.%s, schema=columns={`id` INT NOT
// NULL,`name` VARCHAR(17),`age` INT}, primaryKeys=id, options=()}",
//                                "DataChangeEvent{tableId=%s.%s, before=[], after=[1008, Alice,
// 21], op=INSERT, meta=()}",
//                                "DataChangeEvent{tableId=%s.%s, before=[], after=[1009, Bob, 20],
// op=INSERT, meta=()}",
